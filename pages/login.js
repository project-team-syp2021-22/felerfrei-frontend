...
//todo geht nicht
//import {validator} from '../components/inputValidation'
...
export default function Login(props) {
    ...
    async function tryLogin() {
        ...
        if(!validateEmail(email)){
            return setLoginError("Bitte korrekte Email eingeben")
        }
        setLoginError(null);
        try {
    ...
    //todo ist in /components/inputValidation auch aber ich kann nicht darauf zugreifen

                ...
                <Container className="w-100">
                    ...
                    <Form onSubmit={onSubmit}>
                        <InputGroup className="mb-4 mt-4">
                            <InputGroup.Text id="basic-addon1" className="bg-transparent rounded-0">
                        ...
                        <InputGroup className="mb-4">
                            <InputGroup.Text id="basic-addon2" className="bg-transparent rounded-0">
                        ...
                        <Button className="w-100 rounded-0" variant="outline-dark" type="submit" size={"md"} style={{ transition: '0.5s' }}>
                            Anmelden
                        </Button>
                    </Form>
                </Container>

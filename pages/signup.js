...
export default function Sign_In() {
    ...
    return (
        <div className="d-flex justify-content-center align-items-center w-75 mt-5">
                ...
                <Container className="w-100">
                    ...
                    <Form style={{width: "90vw"}}>
                        ...
                        <Row>
                            ...
                            <div className="w-100" style={{justifyContent: "center", display: "flex"}}>
                                <Form.Label>Das Passwort muss mindestens 8 Zeichen lang sein und Buchstaben, Zahlen und Sonderzeichen enthalten!</Form.Label>
                            </div>
                        </Row>

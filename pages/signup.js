...
import { Container, Form, Spinner, InputGroup, Row, FormControl, Button, Alert, Col } from 'react-bootstrap'
                ...
                <Container className="w-100">
                    ...
                    <Form style={{ width: "500px" }}>
                        ...
                        <Button onClick={trySignUp}
                            ...
                            {loading ? <Spinner animation="border" variant="dark" /> : <>Account anlegen</>}
                        </Button>

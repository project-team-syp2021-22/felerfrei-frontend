...
//todo Deutsch oder Englisch
        if (!validateName(firstname) || !validateName(lastname) || !validateEmail(email)) {
            return setLoginError("Bitte die Felder korrekt ausfüllen")
            //todo was soll ich da schreiben?
        }
                        ...
                        <Form style={{width: "500px"}}>
                            <InputGroup className="mb-4 mt-4">
                                <Form.Control
                                    ...
                                    ref={firstNameRef}
                                    required
                                    onChange={() => validateInput(validateName, firstNameRef)}
                                />
                            </InputGroup>
                            ...
                            <InputGroup className="mb-4 mt-4">
                                <Form.Control
                                    ...
                                    ref={lastNameRef}
                                    required
                                    onChange={() => validateInput(validateName, lastNameRef)}
                                />
                            </InputGroup>
                            <InputGroup className="mb-4 mt-4">
                                <PhoneInput
    ...
    //todo die Funktionen sind auch in /components/inputValidation
